...
// 创建一个debug script来注入到页面中分析DOM结构
const debugScript = `
...
// 将debug script保存到文件中，用户可以在浏览器console中运行
fs.writeFileSync(path.resolve(__dirname, 'page11-debug-inject.js'), debugScript, 'utf8');

console.log('✅ Debug script created: scripts/page11-debug-inject.js');
console.log('📋 Instructions for user:');
console.log('1. Open DS-160 Page11 in browser');
console.log('2. Open browser DevTools (F12)');
console.log('3. Go to Console tab');
console.log('4. Copy and paste the content of page11-debug-inject.js');
console.log('5. Press Enter to run the analysis');
console.log('6. Share the console output with the assistant');
